...
to turtle-setup ;; turtle procedure
  ...
  set vision random-in-range 1 8
...
to turtle-eat ;; turtle procedure
  ...
  set sugar (sugar - metabolism + psugar - tax)
...
to turtle-regen
  if age = 31
  [ hatch 1 [set age 1 set vision 0 ] ]
